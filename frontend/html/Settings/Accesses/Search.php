				...
				<div class="table-responsive">
                    ...
                    if ($access->app->logo) {
                        ...
                        echo '<i class="fa fa-rocket app-logo"></i>';
						    ...
						    ?></td>
							<?php if ($this->multiuser) { ?>
								<td><a href="<?php echo userpanel\url('users', ['id' => $access->user->id]); ?>" class="tootips" title="#<?php echo $access->user->id; ?>" target="_blank"><?php echo $access->user->getFullName(); ?></a></td>
							<?php } ?>
							...
							<?php
                            if ($hasButtons) {
                                echo '<td class="center">'.$this->genButtons(['accesses_delete']).'</td>';
                            }
						    ?>
							</tr>
						<?php } ?>
