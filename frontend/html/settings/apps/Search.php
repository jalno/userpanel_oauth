				...
				<div class="table-responsive">
                    ...
                    if ($app->logo) {
                        ...
                        echo '<i class="fa fa-rocket app-logo"></i>';
						    ...
						    ?></td>
								<?php if ($this->multiuser) { ?>
									<td><a href="<?php echo userpanel\url('users', ['id' => $app->user->id]); ?>" target="_blank"><?php echo $app->user->getFullName(); ?></a></td>
								<?php } ?>
							...
							<?php
                            if ($hasButtons) {
                                echo '<td class="center">'.$this->genButtons(['apps_edit', 'apps_delete']).'</td>';
                            }
						    ?>
							</tr>
						<?php } ?>
