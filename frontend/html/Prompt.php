...
?>
	<p><?php echo t('userpanel_oauth.accesses.permission.warning', ['app.name' => $this->app->name]); ?></p>
	<form class="form-login" name="form-login" action="<?php echo userpanel\url('oauth2/authorize', [
	    'response_type' => 'code',
